...
def tiles_to_images(wfc_ns, tile_grid, tile_catalog, tile_size, visualize=False, partial=False, grid_count=None):
    """
...
def make_tile_catalog(nspace):
    ...
    #print(tiles)
    print((tiles.shape[0] * tiles.shape[1], nspace.tile_size, nspace.tile_size, nspace.channels))
    
    
    tile_list = np.array(tiles).reshape((tiles.shape[0] * tiles.shape[1], nspace.tile_size, nspace.tile_size, nspace.channels))
    ## Make Tile Catalog
